...
function NinjaModal ( data ) {
    ...
    // Setup our title.
    this.title = ( 'undefined' != data.title ? data.title : '' );
    // Setup our content.
    this.content = ( 'undefined' != data.content ? data.content : '' );
    ...
    this.useProgressBar = ( 'undefined' != data.useProgressBar ? data.useProgressBar : false );
